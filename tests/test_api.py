"""Tests for Waterkotte EasyCon Home api."""
import asyncio

import aiohttp
from custom_components.waterkotte_easycon_home.api import (
    WaterkotteEasyconHomeApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = WaterkotteEasyconHomeApiClient("test", "test", async_get_clientsession(hass))
